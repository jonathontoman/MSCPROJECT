...
/**
 * Represents a the path calculated by the route planning algorithms. Holds the nodes visted and other data.
 * @author s1011122
 *
 */
public class Path 
{
	...
	public String printPath()
	{
		...
		{
			sb.append(OutputKML.outputPlaceMark(n.getLongitude(),n.getLatitude()));
			sb.append("\r\n");
		}
		return sb.toString();
	}
	...
	/**
	 * No argument constructor, initialises the list of nodes to an empty linked list.
	 */
	public Path ()
	{
	...
	/**
	 * Constructor, creates the path by recursivly going through the previous node references in the AlgorithmNode
	 * @param n - the desintation node
	 */
	...
	/**
	 * @param nodesInPath the nodesInPath to set
	 */
